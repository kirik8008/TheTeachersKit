...
<p>Мы, нижеподписавшиеся, комиссия Огранизация в составе</p>
...
<p>Во исполнении пункта 7.1 договора № <?=$teacher['contract'];?> от «<? $d = explode(' ',$teacher['contract_date']); echo $d[0]; ?>» <ins><?=$d[1];?></ins> <?=$d[2];?> г. Огранизация изымает у Преподователя следующее оборудование, находящееся в исправном состоянии.</p>
