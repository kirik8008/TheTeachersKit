            ...
            <div class="container-fluid">
                <div class="row cm-fix-height">
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <img src="<?=base_url();?>graphics/img/sass-less.png" alt="Less support" class="img-responsive">
                                <br>
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <img src="<?=base_url();?>graphics/img/devices.png" alt="Responsive across devices" class="img-responsive">
                                <br>
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <img src="<?=base_url();?>graphics/img/components.png" alt="Components" class="img-responsive">
                                <br>
                ...
                <div class="row cm-fix-height">
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="dashboard-sales.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="<?=base_url();?>graphics/img/sf/dashboard.svg" alt="dashboard">
                                </span>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="notepad.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="<?=base_url();?>graphics/img/sf/notepad.svg" alt="notepad">
                                </span>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="components-text.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="<?=base_url();?>graphics/img/sf/brick.svg" alt="brick">
                                </span>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="layouts-breadcrumb1.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="<?=base_url();?>graphics/img/sf/window-layout.svg" alt="window-layout">
                                </span>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="ico-sf.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="<?=base_url();?>graphics/img/sf/cat.svg" alt="cat">
                                </span>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="login.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="<?=base_url();?>graphics/img/sf/lock-open.svg" alt="lock-open">
                                </span>
